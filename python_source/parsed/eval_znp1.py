...
def eval_Znp1_cp(n, X_coef_cp, Y_coef_cp, Z_coef_cp, \
    ...
    out = -((is_seq(0,n+2)*Y_coef_cp[1]*dl_p*is_integer(n+2)*py_sum(sum_arg_62,0,n+2)-2*is_seq(0,n)*Y_coef_cp[1]*dl_p*is_integer(n)*py_sum(sum_arg_60,0,n)+is_seq(0,n+2)*X_coef_cp[1]*dl_p*is_integer(n+2)*py_sum(sum_arg_58,0,n+2)-2*is_seq(0,n)*X_coef_cp[1]*dl_p*is_integer(n)*py_sum(sum_arg_56,0,n)+(2*is_seq(0,n)*X_coef_cp[1]*dl_p*Y_coef_cp[n]-2*is_seq(0,n)*Y_coef_cp[1]*dl_p*X_coef_cp[n])*is_integer(n))*tau_p-X_coef_cp[1]*py_sum(sum_arg_7,ceil(n/2)+1,floor(n)+2)+2*is_seq(0,n)*Y_coef_cp[1]*is_integer(n)*py_sum(sum_arg_54,0,n)-2*is_seq(0,n)*Y_coef_cp[1]*is_integer(n)*py_sum(sum_arg_52,0,n)+2*is_seq(0,n)*X_coef_cp[1]*is_integer(n)*py_sum(sum_arg_50,0,n)-2*is_seq(0,n)*X_coef_cp[1]*is_integer(n)*py_sum(sum_arg_48,0,n)+Y_coef_cp[1]*py_sum(sum_arg_46,ceil(n/2)+1,floor(n)+2)+2*is_seq(0,n)*Y_coef_cp[1]*dl_p*is_integer(n)*py_sum(sum_arg_44,0,n)-is_seq(0,n+2)*Y_coef_cp[1]*is_integer(n+2)*py_sum(sum_arg_43,0,n+2)-Y_coef_cp[1]*py_sum(sum_arg_41,ceil(n/2)+1,floor(n)+2)+2*Y_coef_cp[1]*py_sum(sum_arg_4,ceil(n/2),floor(n))+is_seq(0,n+2)*X_coef_cp[1]*is_integer(n+2)*py_sum(sum_arg_39,0,n+2)+X_coef_cp[1]*py_sum(sum_arg_37,ceil(n/2)+1,floor(n)+2)-2*is_seq(0,n)*X_coef_cp[1]*dl_p*is_integer(n)*py_sum(sum_arg_35,0,n)-X_coef_cp[1]*py_sum(sum_arg_34,ceil(n/2)+1,floor(n)+2)+is_seq(0,n+2)*Y_coef_cp[1]*is_integer(n+2)*py_sum(sum_arg_32,0,n+2)+is_seq(0,n+2)*Y_coef_cp[1]*dl_p*kap_p*is_integer(n+2)*py_sum(sum_arg_30,0,n+2)-is_seq(0,n+2)*Y_coef_cp[1]*dl_p*is_integer(n+2)*py_sum(sum_arg_3,0,n+2)+is_seq(0,n+2)*Y_coef_cp[1]*dl_p*kap_p*is_integer(n+2)*py_sum(sum_arg_28,0,n+2)-2*is_seq(0,n)*Y_coef_cp[1]*dl_p*kap_p*is_integer(n)*py_sum(sum_arg_26,0,n)-2*is_seq(0,n)*Y_coef_cp[1]*dl_p*kap_p*is_integer(n)*py_sum(sum_arg_24,0,n)-is_seq(0,n+2)*X_coef_cp[1]*is_integer(n+2)*py_sum(sum_arg_22,0,n+2)-is_seq(0,n+2)*X_coef_cp[1]*dl_p*kap_p*is_integer(n+2)*py_sum(sum_arg_20,0,n+2)+2*X_coef_cp[1]*py_sum(sum_arg_2,ceil(n/2),floor(n))+2*is_seq(0,n)*X_coef_cp[1]*dl_p*kap_p*is_integer(n)*py_sum(sum_arg_18,0,n)+Y_coef_cp[1]*py_sum(sum_arg_16,ceil(n/2)+1,floor(n)+2)-Y_coef_cp[1]*py_sum(sum_arg_13,ceil(n/2)+1,floor(n)+2)+X_coef_cp[1]*py_sum(sum_arg_10,ceil(n/2)+1,floor(n)+2)+is_seq(0,n+2)*X_coef_cp[1]*dl_p*is_integer(n+2)*py_sum(sum_arg_1,0,n+2)+2*is_seq(0,n)*Y_coef_cp[1]*is_integer(n)*diff(Y_coef_cp[n],False,1)+2*is_seq(0,n)*X_coef_cp[1]*is_integer(n)*diff(X_coef_cp[n],False,1)+2*is_seq(0,n)*X_coef_cp[1]*dl_p*kap_p*Z_coef_cp[n]*is_integer(n))/(2*dl_p*n+2*dl_p)
    return(out)
