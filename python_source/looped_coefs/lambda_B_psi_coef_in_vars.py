...
lambda_dphi_dchi_B_psi_nm2_in_X_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0
...
lambda_dphi_B_psi_nm2_in_Z_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0
lambda_dchi_B_psi_nm2_in_Z_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0
lambda_dphi_dchi_B_psi_nm2_in_Z_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0
...
lambda_dphi_dchi_B_psi_nm2_in_p_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0
...
lambda_dphi_dchi_B_psi_nm2_in_Delta_n = lambda n_eval, X_coef_cp, Y_coef_cp, B_theta_coef_cp, B_psi_coef_cp, iota_coef, p_perp_coef_cp, Delta_coef_cp, B_denom_coef_c, B_alpha_coef, kap_p, dl_p, tau_p: \
    0