...
def eval_loop(n, X_coef_cp, Y_coef_cp, Z_coef_cp, \
    ...
    def sum_arg_137(i350):
        ...
        def sum_arg_136(i228):
            ...
            return(diff(p_perp_coef_cp[i228],'phi',1)*py_sum(sum_arg_135,0,n-i350-i228))
    ...
    def sum_arg_18(i353):
        ...
        def sum_arg_17(i354):
            ...
            def sum_arg_16(i767):
                ...
                return(diff(p_perp_coef_cp[i767],'chi',1)*py_sum(sum_arg_15,0,(-i767)-i354+i353))
    ...
    def sum_arg_14(i351):
        ...
        def sum_arg_13(i234):
            ...
            return(diff(p_perp_coef_cp[i234],'chi',1)*py_sum(sum_arg_12,0,(-n)+2*i351-i234))
    ...
    out = -(((2*Delta_coef_cp[0]-2)*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_153,0,n)+(2-2*Delta_coef_cp[0])*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_152,0,n)+(2*Delta_coef_cp[0]-2)*dl_p*is_integer(n)*py_sum_parallel(sum_arg_151,0,n)+(2-2*Delta_coef_cp[0])*dl_p*is_integer(n)*py_sum_parallel(sum_arg_150,0,n))*diff(tau_p,'phi',1)+((2*Delta_coef_cp[0]-2)*iota_coef[0]*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_149,0,n)+(2*Delta_coef_cp[0]-2)*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_148,0,n)+2*diff(Delta_coef_cp[0],'phi',1)*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_147,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_146,0,n)+(2-2*Delta_coef_cp[0])*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_145,0,n)-2*diff(Delta_coef_cp[0],'phi',1)*dl_p*n*is_integer(n)*py_sum_parallel(sum_arg_144,0,n)+(2*Delta_coef_cp[0]-2)*dl_p*is_integer(n)*py_sum_parallel(sum_arg_143,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*dl_p*is_integer(n)*py_sum_parallel(sum_arg_142,0,n)+2*diff(Delta_coef_cp[0],'phi',1)*dl_p*is_integer(n)*py_sum_parallel(sum_arg_141,0,n)+(2-2*Delta_coef_cp[0])*dl_p*is_integer(n)*py_sum_parallel(sum_arg_140,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*dl_p*is_integer(n)*py_sum_parallel(sum_arg_139,0,n)-2*diff(Delta_coef_cp[0],'phi',1)*dl_p*is_integer(n)*py_sum_parallel(sum_arg_138,0,n))*tau_p+((2*Delta_coef_cp[0]-2)*dl_p*diff(kap_p,'phi',1)+2*diff(Delta_coef_cp[0],'phi',1)*dl_p*kap_p)*n*is_integer(n)*py_sum_parallel(sum_arg_99,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*dl_p*kap_p*n*is_integer(n)*py_sum_parallel(sum_arg_98,0,n)+(2-2*Delta_coef_cp[0])*dl_p*kap_p*n*is_integer(n)*py_sum_parallel(sum_arg_97,0,n)+((2-2*Delta_coef_cp[0])*dl_p*diff(kap_p,'phi',1)-2*diff(Delta_coef_cp[0],'phi',1)*dl_p*kap_p)*n*is_integer(n)*py_sum_parallel(sum_arg_96,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*py_sum_parallel(sum_arg_95,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*py_sum_parallel(sum_arg_93,ceil(n/2),floor(n))-2*diff(Delta_coef_cp[0],'phi',1)*n*py_sum_parallel(sum_arg_91,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*is_integer(n)*py_sum_parallel(sum_arg_89,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_88,0,n)-2*diff(Delta_coef_cp[0],'phi',1)*n*is_integer(n)*py_sum_parallel(sum_arg_87,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*py_sum_parallel(sum_arg_86,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*py_sum_parallel(sum_arg_84,ceil(n/2),floor(n))-2*diff(Delta_coef_cp[0],'phi',1)*n*py_sum_parallel(sum_arg_82,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*is_integer(n)*py_sum_parallel(sum_arg_80,0,n)+4*B_alpha_coef[0]*py_sum_parallel(sum_arg_8,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_79,0,n)-2*diff(Delta_coef_cp[0],'phi',1)*n*is_integer(n)*py_sum_parallel(sum_arg_78,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*py_sum_parallel(sum_arg_77,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*py_sum_parallel(sum_arg_75,ceil(n/2),floor(n))-2*diff(Delta_coef_cp[0],'phi',1)*n*py_sum_parallel(sum_arg_73,ceil(n/2),floor(n))+(2-2*Delta_coef_cp[0])*n*is_integer(n)*py_sum_parallel(sum_arg_71,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_70,0,n)-2*diff(Delta_coef_cp[0],'phi',1)*n*is_integer(n)*py_sum_parallel(sum_arg_69,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*py_sum_parallel(sum_arg_68,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*py_sum_parallel(sum_arg_66,ceil(n/2),floor(n))+2*diff(Delta_coef_cp[0],'phi',1)*py_sum_parallel(sum_arg_64,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*iota_coef[0]*py_sum_parallel(sum_arg_62,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*py_sum_parallel(sum_arg_60,ceil(n/2),floor(n))+2*diff(Delta_coef_cp[0],'phi',1)*py_sum_parallel(sum_arg_58,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*iota_coef[0]*py_sum_parallel(sum_arg_56,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*py_sum_parallel(sum_arg_54,ceil(n/2),floor(n))+2*diff(Delta_coef_cp[0],'phi',1)*py_sum_parallel(sum_arg_52,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*is_integer(n)*py_sum_parallel(sum_arg_50,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*is_integer(n)*py_sum_parallel(sum_arg_49,0,n)+2*diff(Delta_coef_cp[0],'phi',1)*is_integer(n)*py_sum_parallel(sum_arg_48,0,n)+(2*Delta_coef_cp[0]-2)*is_integer(n)*py_sum_parallel(sum_arg_47,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*is_integer(n)*py_sum_parallel(sum_arg_46,0,n)+2*diff(Delta_coef_cp[0],'phi',1)*is_integer(n)*py_sum_parallel(sum_arg_45,0,n)+(2*Delta_coef_cp[0]-2)*is_integer(n)*py_sum_parallel(sum_arg_44,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*is_integer(n)*py_sum_parallel(sum_arg_43,0,n)+2*diff(Delta_coef_cp[0],'phi',1)*is_integer(n)*py_sum_parallel(sum_arg_42,0,n)+(2*Delta_coef_cp[0]-2)*dl_p*kap_p*is_integer(n)*py_sum_parallel(sum_arg_41,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*dl_p*kap_p*is_integer(n)*py_sum_parallel(sum_arg_40,0,n)+((2*Delta_coef_cp[0]-2)*dl_p*diff(kap_p,'phi',1)+2*diff(Delta_coef_cp[0],'phi',1)*dl_p*kap_p)*is_integer(n)*py_sum_parallel(sum_arg_39,0,n)+(2-2*Delta_coef_cp[0])*dl_p*kap_p*is_integer(n)*py_sum_parallel(sum_arg_38,0,n)+(2-2*Delta_coef_cp[0])*iota_coef[0]*dl_p*kap_p*is_integer(n)*py_sum_parallel(sum_arg_37,0,n)+((2-2*Delta_coef_cp[0])*dl_p*diff(kap_p,'phi',1)-2*diff(Delta_coef_cp[0],'phi',1)*dl_p*kap_p)*is_integer(n)*py_sum_parallel(sum_arg_36,0,n)+(2*Delta_coef_cp[0]-2)*iota_coef[0]*n*py_sum_parallel(sum_arg_35,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*n*py_sum_parallel(sum_arg_33,ceil(n/2),floor(n))+2*diff(Delta_coef_cp[0],'phi',1)*n*py_sum_parallel(sum_arg_31,ceil(n/2),floor(n))+(4-4*Delta_coef_cp[0])*iota_coef[0]*py_sum_parallel(sum_arg_29,ceil(n/2)-1,floor(n)-2)+(4-4*Delta_coef_cp[0])*py_sum_parallel(sum_arg_27,ceil(n/2)-1,floor(n)-2)-4*diff(Delta_coef_cp[0],'phi',1)*py_sum_parallel(sum_arg_25,ceil(n/2)-1,floor(n)-2)+n*((-B_alpha_coef[0]*py_sum_parallel(sum_arg_23,ceil(n/2),floor(n)))+B_alpha_coef[0]*py_sum_parallel(sum_arg_20,ceil(n/2),floor(n))+2*B_alpha_coef[0]*py_sum_parallel(sum_arg_18,ceil(n/2),floor(n))-2*B_alpha_coef[0]*py_sum_parallel(sum_arg_14,ceil(n/2),floor(n)))+2*B_alpha_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_137,0,n)-2*B_alpha_coef[0]*n*py_sum_parallel(sum_arg_134,ceil(n/2),floor(n))-2*B_alpha_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_131,0,n)+4*B_alpha_coef[0]*is_seq(0,n-2)*is_integer(n-2)*py_sum_parallel(sum_arg_129,0,n-2)+4*B_alpha_coef[0]*is_seq(0,n-2)*is_integer(n-2)*py_sum_parallel(sum_arg_126,0,n-2)+2*B_alpha_coef[0]*n*py_sum_parallel(sum_arg_123,ceil(n/2),floor(n))+2*B_alpha_coef[0]*n*is_integer(n)*py_sum_parallel(sum_arg_121,0,n)+4*B_alpha_coef[0]*py_sum_parallel(sum_arg_120,ceil(n/2)-1,floor(n)-2)+4*B_alpha_coef[0]*py_sum_parallel(sum_arg_116,ceil(n/2)-1,floor(n)-2)-4*B_alpha_coef[0]*py_sum_parallel(sum_arg_112,ceil(n/2),floor(n))-4*B_alpha_coef[0]*py_sum_parallel(sum_arg_110,ceil(n/2)-1,floor(n)-2)-4*B_alpha_coef[0]*py_sum_parallel(sum_arg_11,ceil(n/2),floor(n))-4*B_alpha_coef[0]*is_seq(0,n-2)*is_integer(n-2)*py_sum_parallel(sum_arg_108,0,n-2)-B_alpha_coef[0]*py_sum_parallel(sum_arg_107,ceil(n/2),floor(n))+2*B_alpha_coef[0]*py_sum_parallel(sum_arg_105,ceil(n/2),floor(n))+(2*Delta_coef_cp[0]-2)*iota_coef[0]*dl_p*kap_p*n*is_integer(n)*py_sum_parallel(sum_arg_101,0,n)+(2*Delta_coef_cp[0]-2)*dl_p*kap_p*n*is_integer(n)*py_sum_parallel(sum_arg_100,0,n)+4*B_alpha_coef[0]*py_sum_parallel(sum_arg_1,ceil(n/2),floor(n)))/(2*B_alpha_coef[0]*n)
    return(out)
