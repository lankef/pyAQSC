...
def validate_J(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    out = (((-is_seq(0,n)*dl_p**2*is_integer(n)*py_sum_parallel(sum_arg_38,0,n))-is_seq(0,n)*dl_p**2*is_integer(n)*py_sum_parallel(sum_arg_37,0,n))*tau_p**2)\
        ...
        +(-2*is_seq(0,n)*dl_p*is_integer(n)*diff(Z_coef_cp[n],'phi',1))\
...
def validate_Ck(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    def sum_arg_27(i118):
        ...
        return(diff(Z_coef_cp[i118],'chi',1)*py_sum(sum_arg_26,0,n-i118))
    
    def sum_arg_25(i732):
        # Child args for sum_arg_25    
        def sum_arg_24(i140):
            # Child args for sum_arg_24
            return(B_psi_coef_cp[i140]*diff(Y_coef_cp[n-i732-i140],'phi',1))
        
        return(diff(Z_coef_cp[i732],'chi',1)*py_sum(sum_arg_24,0,n-i732))
    
    def sum_arg_23(i726):
        # Child args for sum_arg_23    
        def sum_arg_22(i136):
            # Child args for sum_arg_22
            return(B_psi_coef_cp[i136]*diff(Y_coef_cp[n-i726-i136],'chi',1))
        
        return(diff(Z_coef_cp[i726],'phi',1)*py_sum(sum_arg_22,0,n-i726))
    ...
    def sum_arg_21(i734):
        ...
        return(diff(Z_coef_cp[i734],'phi',1)*py_sum(sum_arg_20,0,n-i734+2))
    
    def sum_arg_19(i729):
        # Child args for sum_arg_19    
        def sum_arg_18(i730):
            # Child args for sum_arg_18
            return(diff(Y_coef_cp[i730],'chi',1)*Z_coef_cp[(-n)-i730+2*i729-2]*((-n)-i730+2*i729-2)*is_seq(n-i729+2,i729-i730))
        
        return(is_seq(0,n-i729+2)*B_alpha_coef[n-i729+2]*is_integer(n-i729+2)*py_sum(sum_arg_18,0,i729))
    
    def sum_arg_17(i728):
        # Child args for sum_arg_17
        return(B_psi_coef_cp[i728]*diff(Y_coef_cp[n-i728],'chi',1))
    
    def sum_arg_16(i721):
        # Child args for sum_arg_16    
        def sum_arg_15(i722):
            # Child args for sum_arg_15
            return(diff(Z_coef_cp[i722],'chi',1)*Y_coef_cp[(-n)-i722+2*i721-2]*((-n)-i722+2*i721-2)*is_seq(n-i721+2,i721-i722))
    ...
    def sum_arg_14(i146):
        ...
        return(diff(Y_coef_cp[i146],'phi',1)*py_sum(sum_arg_13,0,n-i146+2))
    ...
    def sum_arg_10(i126):
        ...
        return(diff(Y_coef_cp[i126],'chi',1)*py_sum(sum_arg_9,0,n-i126))
    ...
    def sum_arg_8(i735):
        ...
        def sum_arg_7(i736):
            ...
            def sum_arg_6(i1191):
                # Child args for sum_arg_6
                return(i1191*Y_coef_cp[i1191]*diff(Z_coef_cp[(-i736)+i735-i1191],'chi',1))
    ...
    def sum_arg_5(i723):
        ...
        def sum_arg_4(i724):
            ...
            def sum_arg_3(i1175):
                # Child args for sum_arg_3
                return(i1175*Z_coef_cp[i1175]*diff(Y_coef_cp[(-i724)+i723-i1175],'chi',1))
    ...
    out = (-(is_seq(0,n+2)*dl_p*is_integer(n+2)*py_sum_parallel(sum_arg_29,0,n+2)*tau_p)/2)\
        ...
        +(-is_seq(0,n)*is_integer(n)*diff(X_coef_cp[n],'phi',1))\
...
def validate_Ct(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    def sum_arg_31(i158):
        ...
        return(diff(Z_coef_cp[i158],'chi',1)*py_sum(sum_arg_30,0,n-i158))
    
    def sum_arg_29(i1200):
        # Child args for sum_arg_29    
        def sum_arg_28(i188):
            # Child args for sum_arg_28
            return(B_psi_coef_cp[i188]*diff(X_coef_cp[n-i188-i1200],'phi',1))
        
        return(diff(Z_coef_cp[i1200],'chi',1)*py_sum(sum_arg_28,0,n-i1200))
    
    def sum_arg_27(i1206):
        # Child args for sum_arg_27    
        def sum_arg_26(i184):
            # Child args for sum_arg_26
            return(B_psi_coef_cp[i184]*diff(X_coef_cp[n-i184-i1206],'chi',1))
        
        return(diff(Z_coef_cp[i1206],'phi',1)*py_sum(sum_arg_26,0,n-i1206))
    ...
    def sum_arg_25(i194):
        ...
        return(diff(X_coef_cp[i194],'phi',1)*py_sum(sum_arg_24,0,n-i194+2))
    ...
    def sum_arg_23(i1196):
        ...
        return(diff(Z_coef_cp[i1196],'phi',1)*py_sum(sum_arg_22,0,n-i1196+2))
    ...
    def sum_arg_17(i170):
        ...
        return(diff(X_coef_cp[i170],'chi',1)*py_sum(sum_arg_16,0,n-i170))
    ...
    def sum_arg_15(i166):
        ...
        return(diff(Z_coef_cp[i166],'chi',1)*py_sum(sum_arg_14,0,n-i166))
    
    def sum_arg_13(i1203):
        # Child args for sum_arg_13    
        def sum_arg_12(i1204):
            # Child args for sum_arg_12
            return(diff(Z_coef_cp[i1204],'chi',1)*X_coef_cp[(-n)-i1204+2*i1203-2]*((-n)-i1204+2*i1203-2)*is_seq(n-i1203+2,i1203-i1204))
        
        return(is_seq(0,n-i1203+2)*B_alpha_coef[n-i1203+2]*is_integer(n-i1203+2)*py_sum(sum_arg_12,0,i1203))
    
    def sum_arg_11(i1202):
        # Child args for sum_arg_11
        return(B_psi_coef_cp[i1202]*diff(X_coef_cp[n-i1202],'chi',1))
    
    def sum_arg_10(i1193):
        # Child args for sum_arg_10    
        def sum_arg_9(i1194):
            # Child args for sum_arg_9
            return(diff(X_coef_cp[i1194],'chi',1)*Z_coef_cp[(-n)-i1194+2*i1193-2]*((-n)-i1194+2*i1193-2)*is_seq(n-i1193+2,i1193-i1194))
    ...
    def sum_arg_6(i1207):
        ...
        def sum_arg_5(i1208):
            ...
            def sum_arg_4(i1664):
                # Child args for sum_arg_4
                return(diff(X_coef_cp[(-i1664)-i1208+i1207],'chi',1)*i1664*Z_coef_cp[i1664])
    ...
    def sum_arg_3(i1197):
        ...
        def sum_arg_2(i1198):
            ...
            def sum_arg_1(i1648):
                # Child args for sum_arg_1
                return(diff(Z_coef_cp[(-i1648)-i1198+i1197],'chi',1)*i1648*X_coef_cp[i1648])
    ...
    out = (-(is_seq(0,n+2)*dl_p*is_integer(n+2)*py_sum_parallel(sum_arg_33,0,n+2)*tau_p)/2)\
        ...
        +(-is_seq(0,n)*is_integer(n)*diff(Y_coef_cp[n],'phi',1))
    return(out)
def validate_I(n, B_denom_coef_c,
    ...
    def sum_arg_10(i1670):
        ...
        return(diff(p_perp_coef_cp[i1670],'phi',1)*py_sum(sum_arg_9,0,n-i1670))
    ...
    def sum_arg_8(i1671):
        ...
        def sum_arg_7(i1672):
            ...
            return(diff(p_perp_coef_cp[(-n)-i1672+2*i1671],'chi',1)*is_seq(n-i1671,i1671-i1672)*py_sum(sum_arg_6,0,i1672))
    ...
    def sum_arg_5(i1667):
        ...
        def sum_arg_4(i1668):
            # Child args for sum_arg_4
            return(B_denom_coef_c[i1668]*diff(Delta_coef_cp[(-n)-i1668+2*i1667],'chi',1)*is_seq(n-i1667,i1667-i1668))
        
        return(is_seq(0,n-i1667)*iota_coef[n-i1667]*is_integer(n-i1667)*py_sum(sum_arg_4,0,i1667))
    
    def sum_arg_3(i1666):
        # Child args for sum_arg_3
        return(B_denom_coef_c[i1666]*diff(Delta_coef_cp[n-i1666],'phi',1))
    
    def sum_arg_2(i1875):
        # Child args for sum_arg_2    
        def sum_arg_1(i224):
            # Child args for sum_arg_1
            return(Delta_coef_cp[i224]*diff(B_denom_coef_c[(-n)-i224+2*i1875],'chi',1))
...
def validate_II(n, 
    ...
    def sum_arg_23(i1890):
        ...
        def sum_arg_22(i228):
            ...
            return(diff(p_perp_coef_cp[i228],'phi',1)*py_sum(sum_arg_21,0,n-i228-i1890))
    ...
    def sum_arg_20(i1887):
        ...
        def sum_arg_19(i1888):
            ...
            def sum_arg_18(i1886):
                # Child args for sum_arg_18
                return(Delta_coef_cp[i1886]*diff(B_theta_coef_cp[(-n)-i1888+2*i1887-i1886],'chi',1)*is_seq(n-i1887,(-i1888)+i1887-i1886))
    ...
    def sum_arg_17(i1884):
        ...
        def sum_arg_16(i1882):
            # Child args for sum_arg_16
            return(Delta_coef_cp[i1882]*diff(B_theta_coef_cp[n-i1884-i1882],'phi',1))
    ...
    def sum_arg_15(i1879):
        ...
        def sum_arg_14(i1880):
            # Child args for sum_arg_14
            return(B_denom_coef_c[i1880]*diff(B_theta_coef_cp[(-n)-i1880+2*i1879],'chi',1)*is_seq(n-i1879,i1879-i1880))
        
        return(is_seq(0,n-i1879)*iota_coef[n-i1879]*is_integer(n-i1879)*py_sum(sum_arg_14,0,i1879))
    
    def sum_arg_13(i1878):
        # Child args for sum_arg_13
        return(B_denom_coef_c[i1878]*diff(B_theta_coef_cp[n-i1878],'phi',1))
    ...
    def sum_arg_12(i1897):
        ...
        def sum_arg_11(i1898):
            ...
            def sum_arg_10(i2338):
                # Child args for sum_arg_10
                return(diff(B_denom_coef_c[(-i2338)-i1898+i1897],'chi',1)*Delta_coef_cp[i2338])
    ...
    def sum_arg_9(i1895):
        ...
        def sum_arg_8(i238):
            # Child args for sum_arg_8
            return(Delta_coef_cp[i238]*diff(B_denom_coef_c[(-n)-i238+2*i1895],'chi',1))
    ...
    def sum_arg_7(i1893):
        ...
        def sum_arg_6(i1894):
            ...
            def sum_arg_5(i2322):
                ...
                return(diff(p_perp_coef_cp[i2322],'chi',1)*py_sum(sum_arg_4,0,(-i2322)-i1894+i1893))
    ...
    def sum_arg_3(i1891):
        ...
        def sum_arg_2(i234):
            ...
            return(diff(p_perp_coef_cp[i234],'chi',1)*py_sum(sum_arg_1,0,(-n)-i234+2*i1891))
...
def validate_III(n,
    ...
    def sum_arg_29(i2368):
        ...
        def sum_arg_28(i2366):
            # Child args for sum_arg_28
            return(Delta_coef_cp[i2366]*diff(B_psi_coef_cp[n-i2368-i2366],'phi',1))
    ...
    def sum_arg_27(i2355):
        ...
        def sum_arg_26(i2356):
            ...
            def sum_arg_25(i2350):
                # Child args for sum_arg_25
                return(Delta_coef_cp[i2350]*diff(B_psi_coef_cp[(-n)-i2356+2*i2355-i2350],'chi',1)*is_seq(n-i2355,(-i2356)+i2355-i2350))
    ...
    def sum_arg_24(i2353):
        ...
        def sum_arg_23(i2354):
            ...
            def sum_arg_22(i2348):
                # Child args for sum_arg_22
                return(B_psi_coef_cp[i2348]*diff(Delta_coef_cp[(-n)-i2354+2*i2353-i2348],'chi',1)*is_seq(n-i2353,(-i2354)+i2353-i2348))
    ...
    def sum_arg_21(i2352):
        ...
        def sum_arg_20(i2346):
            # Child args for sum_arg_20
            return(B_psi_coef_cp[i2346]*diff(Delta_coef_cp[n-i2352-i2346],'phi',1))
    ...
    def sum_arg_16(i2375):
        ...
        def sum_arg_15(i2376):
            # Child args for sum_arg_15
            return(B_denom_coef_c[i2376]*diff(B_psi_coef_cp[(-n)-i2376+2*i2375],'chi',1)*is_seq(n-i2375,i2375-i2376))
        
        return(is_seq(0,n-i2375)*iota_coef[n-i2375]*is_integer(n-i2375)*py_sum(sum_arg_15,0,i2375))
    
    def sum_arg_14(i2364):
        # Child args for sum_arg_14
        return(B_denom_coef_c[i2364]*diff(B_psi_coef_cp[n-i2364],'phi',1))
...
def validate_E6(n,
    ...
    def sum_arg_29(i2420):
        ...
        def sum_arg_28(i2382):
            # Child args for sum_arg_28
            return(B_psi_coef_cp[i2382]*diff(Delta_coef_cp[n-i2420-i2382],'phi',1))
    ...
    def sum_arg_27(i2416):
        ...
        def sum_arg_26(i2414):
            # Child args for sum_arg_26
            return(Delta_coef_cp[i2414]*diff(B_psi_coef_cp[n-i2416-i2414],'phi',1))
    ...
    def sum_arg_25(i2411):
        ...
        def sum_arg_24(i2412):
            ...
            def sum_arg_23(i2384):
                # Child args for sum_arg_23
                return(B_psi_coef_cp[i2384]*diff(Delta_coef_cp[(-n)-i2412+2*i2411-i2384],'chi',1))
    ...
    def sum_arg_22(i2407):
        ...
        def sum_arg_21(i2408):
            ...
            def sum_arg_20(i2404):
                # Child args for sum_arg_20
                return(Delta_coef_cp[i2404]*diff(B_psi_coef_cp[(-n)-i2408+2*i2407-i2404],'chi',1))
    ...
    def sum_arg_17(i2391):
        ...
        def sum_arg_16(i2392):
            # Child args for sum_arg_16
            return(B_denom_coef_c[i2392]*diff(B_psi_coef_cp[(-n)-i2392+2*i2391],'chi',1)*is_seq(n-i2391,i2391-i2392))
        
        return(is_seq(0,n-i2391)*iota_coef[n-i2391]*is_integer(n-i2391)*py_sum(sum_arg_16,0,i2391))
    
    def sum_arg_15(i2390):
        # Child args for sum_arg_15
        return(B_denom_coef_c[i2390]*diff(B_psi_coef_cp[n-i2390],'phi',1))
...
def validate_D2(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    def sum_arg_13(i2459):
        ...
        def sum_arg_12(i2460):
            # Child args for sum_arg_12
            return(i2460*Z_coef_cp[i2460]*diff(Z_coef_cp[(-n)-i2460+2*i2459-2],'chi',1)*is_seq(n-i2459+2,i2459-i2460))
    ...
    def sum_arg_11(i2457):
        ...
        def sum_arg_10(i2458):
            # Child args for sum_arg_10
            return(i2458*Y_coef_cp[i2458]*diff(Y_coef_cp[(-n)-i2458+2*i2457-2],'chi',1)*is_seq(n-i2457+2,i2457-i2458))
    ...
    def sum_arg_9(i2455):
        ...
        def sum_arg_8(i2456):
            # Child args for sum_arg_8
            return(i2456*X_coef_cp[i2456]*diff(X_coef_cp[(-n)-i2456+2*i2455-2],'chi',1)*is_seq(n-i2455+2,i2455-i2456))
        
        return(is_seq(0,n-i2455+2)*iota_coef[n-i2455+2]*is_integer(n-i2455+2)*py_sum(sum_arg_8,0,i2455))
    
    def sum_arg_7(i2454):
        # Child args for sum_arg_7
        return(i2454*Z_coef_cp[i2454]*diff(Z_coef_cp[n-i2454+2],'phi',1))
    
    def sum_arg_6(i2452):
        # Child args for sum_arg_6
        return(i2452*Y_coef_cp[i2452]*diff(Y_coef_cp[n-i2452+2],'phi',1))
    
    def sum_arg_5(i2450):
        # Child args for sum_arg_5
        return(i2450*X_coef_cp[i2450]*diff(X_coef_cp[n-i2450+2],'phi',1))
...
def validate_D3(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    def sum_arg_15(i2438):
        # Child args for sum_arg_15
        return(X_coef_cp[i2438]*diff(Y_coef_cp[n-i2438],'chi',1))
    
    def sum_arg_14(i2434):
        # Child args for sum_arg_14
        return(Y_coef_cp[i2434]*diff(X_coef_cp[n-i2434],'chi',1))
    
    def sum_arg_13(i2440):
        # Child args for sum_arg_13
        return(X_coef_cp[i2440]*diff(Z_coef_cp[n-i2440],'chi',1))
    
    def sum_arg_12(i2436):
        # Child args for sum_arg_12
        return(Z_coef_cp[i2436]*diff(X_coef_cp[n-i2436],'chi',1))
    
    def sum_arg_11(i2431):
        # Child args for sum_arg_11    
        def sum_arg_10(i2432):
            # Child args for sum_arg_10
            return(diff(Z_coef_cp[i2432],'chi',1)*diff(Z_coef_cp[(-n)-i2432+2*i2431],'chi',1)*is_seq(n-i2431,i2431-i2432))
        
        return(is_seq(0,n-i2431)*iota_coef[n-i2431]*is_integer(n-i2431)*py_sum(sum_arg_10,0,i2431))
    
    def sum_arg_9(i2430):
        # Child args for sum_arg_9
        return(diff(Z_coef_cp[i2430],'chi',1)*diff(Z_coef_cp[n-i2430],'phi',1))
    
    def sum_arg_8(i2427):
        # Child args for sum_arg_8    
        def sum_arg_7(i2428):
            # Child args for sum_arg_7
            return(diff(Y_coef_cp[i2428],'chi',1)*diff(Y_coef_cp[(-n)-i2428+2*i2427],'chi',1)*is_seq(n-i2427,i2427-i2428))
        
        return(is_seq(0,n-i2427)*iota_coef[n-i2427]*is_integer(n-i2427)*py_sum(sum_arg_7,0,i2427))
    
    def sum_arg_6(i2426):
        # Child args for sum_arg_6
        return(diff(Y_coef_cp[i2426],'chi',1)*diff(Y_coef_cp[n-i2426],'phi',1))
    
    def sum_arg_5(i2423):
        # Child args for sum_arg_5    
        def sum_arg_4(i2424):
            # Child args for sum_arg_4
            return(diff(X_coef_cp[i2424],'chi',1)*diff(X_coef_cp[(-n)-i2424+2*i2423],'chi',1)*is_seq(n-i2423,i2423-i2424))
        
        return(is_seq(0,n-i2423)*iota_coef[n-i2423]*is_integer(n-i2423)*py_sum(sum_arg_4,0,i2423))
    
    def sum_arg_3(i2422):
        # Child args for sum_arg_3
        return(diff(X_coef_cp[i2422],'chi',1)*diff(X_coef_cp[n-i2422],'phi',1))
...
def validate_kt(n, X_coef_cp, Y_coef_cp, Z_coef_cp,
    ...
    def sum_arg_58(i1200):
        ...
        return(diff(Z_coef_cp[i1200],'chi',1)*py_sum(sum_arg_57,0,n-i1200))
    ...
    def sum_arg_56(i1206):
        ...
        return(diff(Z_coef_cp[i1206],'phi',1)*py_sum(sum_arg_55,0,n-i1206))
    ...
    def sum_arg_54(i194):
        ...
        return(diff(X_coef_cp[i194],'phi',1)*py_sum(sum_arg_53,0,n-i194+2))
    ...
    def sum_arg_52(i1196):
        ...
        return(diff(Z_coef_cp[i1196],'phi',1)*py_sum(sum_arg_51,0,n-i1196+2))
    ...
    def sum_arg_46(i170):
        ...
        return(diff(X_coef_cp[i170],'chi',1)*py_sum(sum_arg_45,0,n-i170))
    ...
    def sum_arg_44(i166):
        ...
        return(diff(Z_coef_cp[i166],'chi',1)*py_sum(sum_arg_43,0,n-i166))
    ...
    def sum_arg_28(i118):
        ...
        return(diff(Z_coef_cp[i118],'chi',1)*py_sum(sum_arg_27,0,n-i118))
    ...
    def sum_arg_26(i732):
        ...
        return(diff(Z_coef_cp[i732],'chi',1)*py_sum(sum_arg_25,0,n-i732))
    ...
    def sum_arg_24(i726):
        ...
        return(diff(Z_coef_cp[i726],'phi',1)*py_sum(sum_arg_23,0,n-i726))
    ...
    def sum_arg_22(i734):
        ...
        return(diff(Z_coef_cp[i734],'phi',1)*py_sum(sum_arg_21,0,n-i734+2))
    ...
    def sum_arg_15(i146):
        ...
        return(diff(Y_coef_cp[i146],'phi',1)*py_sum(sum_arg_14,0,n-i146+2))
    ...
    def sum_arg_11(i126):
        ...
        return(diff(Y_coef_cp[i126],'chi',1)*py_sum(sum_arg_10,0,n-i126))
