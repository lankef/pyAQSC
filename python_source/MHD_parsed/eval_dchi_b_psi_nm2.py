...
def eval_dchi_B_psi_cp_nm2(n, X_coef_cp, Y_coef_cp, Z_coef_cp, \
    ...
    def sum_arg_27(i254):
        ...
        return((X_coef_cp[i254]*n-i254*X_coef_cp[i254])*diff(Y_coef_cp[n-i254],'chi',1)+(diff(X_coef_cp[i254],'chi',1)*n-i254*diff(X_coef_cp[i254],'chi',1))*Y_coef_cp[n-i254])
    ...
    def sum_arg_15(i269):
        ...
        def sum_arg_14(i270):
            ...
            return((i270*Z_coef_cp[i270]*diff(Z_coef_cp[(-n)-i270+2*i269],'chi',2)+i270*diff(Z_coef_cp[i270],'chi',1)*diff(Z_coef_cp[(-n)-i270+2*i269],'chi',1))*is_seq(n-i269,i269-i270))
    ...
    def sum_arg_13(i267):
        ...
        def sum_arg_12(i268):
            ...
            return((i268*Y_coef_cp[i268]*diff(Y_coef_cp[(-n)-i268+2*i267],'chi',2)+i268*diff(Y_coef_cp[i268],'chi',1)*diff(Y_coef_cp[(-n)-i268+2*i267],'chi',1))*is_seq(n-i267,i267-i268))
    ...
    def sum_arg_11(i265):
        ...
        def sum_arg_10(i266):
            ...
            return((i266*X_coef_cp[i266]*diff(X_coef_cp[(-n)-i266+2*i265],'chi',2)+i266*diff(X_coef_cp[i266],'chi',1)*diff(X_coef_cp[(-n)-i266+2*i265],'chi',1))*is_seq(n-i265,i265-i266))
    ...
    def sum_arg_5(i252):
        ...
        return((X_coef_cp[i252]*n-i252*X_coef_cp[i252])*diff(Z_coef_cp[n-i252],'chi',1)+(diff(X_coef_cp[i252],'chi',1)*n-i252*diff(X_coef_cp[i252],'chi',1))*Z_coef_cp[n-i252])
