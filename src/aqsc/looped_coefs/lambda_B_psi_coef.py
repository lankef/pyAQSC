...
coef_B_psi_dphi_1_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_1_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:-((3*Delta_coef_cp[0]-3)*iota_coef[0]**2*X_coef_cp[1]**2*diff(Y_coef_cp[1],True,1)+(3-3*Delta_coef_cp[0])*iota_coef[0]**2*X_coef_cp[1]*Y_coef_cp[1]*diff(X_coef_cp[1],True,1))/(B_alpha_coef[0]*dl_p*kap_p*n_eval**2-B_alpha_coef[0]*dl_p*kap_p*n_eval), static_argnums=(0, ))
coef_B_psi_dphi_1_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_1_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_1_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_1_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_1_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_1_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_1_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_1_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_1_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
...
coef_B_psi_dphi_2_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
...
coef_B_psi_dphi_2_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:-((3*Delta_coef_cp[0]-3)*iota_coef[0]*X_coef_cp[1]**2*diff(Y_coef_cp[1],True,1)+(3-3*Delta_coef_cp[0])*iota_coef[0]*X_coef_cp[1]*Y_coef_cp[1]*diff(X_coef_cp[1],True,1))/(B_alpha_coef[0]*dl_p*kap_p*n_eval**2-B_alpha_coef[0]*dl_p*kap_p*n_eval), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_2_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_2_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:(((Delta_coef_cp[0]-1)*X_coef_cp[1]*diff(X_coef_cp[1],True,1)*diff(Y_coef_cp[1],True,1)+(1-Delta_coef_cp[0])*Y_coef_cp[1]*(diff(X_coef_cp[1],True,1))**2)*n_eval+(1-Delta_coef_cp[0])*X_coef_cp[1]**2*diff(Y_coef_cp[1],True,2)+(1-Delta_coef_cp[0])*X_coef_cp[1]*diff(X_coef_cp[1],True,1)*diff(Y_coef_cp[1],True,1)+(Delta_coef_cp[0]-1)*X_coef_cp[1]*Y_coef_cp[1]*diff(X_coef_cp[1],True,2)+(Delta_coef_cp[0]-1)*Y_coef_cp[1]*(diff(X_coef_cp[1],True,1))**2)/(B_alpha_coef[0]*dl_p*kap_p*n_eval**2-B_alpha_coef[0]*dl_p*kap_p*n_eval), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:-((Delta_coef_cp[0]-1)*X_coef_cp[1]**2*diff(Y_coef_cp[1],True,1)+(1-Delta_coef_cp[0])*X_coef_cp[1]*Y_coef_cp[1]*diff(X_coef_cp[1],True,1))/(B_alpha_coef[0]*dl_p*kap_p*n_eval**2-B_alpha_coef[0]*dl_p*kap_p*n_eval), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_3_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_3_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_4_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_4_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_5_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_5_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_6_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_6_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_0_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_0_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_1_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_1_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_2_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_2_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_3_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_3_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_4_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_4_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_5_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_5_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_6_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_6_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

coef_B_psi_dphi_7_dchi_7_all_but_Y = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))
coef_B_psi_dphi_7_dchi_7_in_Y_RHS = jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
    Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
    dl_p, tau_p, kap_p, iota_coef:ChiPhiFuncSpecial(0), static_argnums=(0, ))

# for tracking B_theta dependence
tensor_fft_op_B_psi_in_all_but_Y = \
    jit(lambda n_eval, X_coef_cp, Y_coef_cp,\
        Delta_coef_cp, B_alpha_coef, B_denom_coef_c,\
        ...
        +0, static_argnums=(0, 10, 11, 12, 13))
